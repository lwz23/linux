...
extern "C" fn tty0tty_set_termios<T:Tty0ttyMethods>(tty: *mut bindings::tty_struct,old_termios:* mut bindings::ktermios){
    T::set_termios(&mut TtyStruct(tty),&mut Ktermios(old_termios));
}
